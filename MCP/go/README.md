# Web Search Client MCP Server

This MCP (Model Content Protocol) server provides access to Web Search Client API functionality through HTTP, HTTPS, and STDIO transport modes.
